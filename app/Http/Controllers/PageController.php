...
class PageController extends Controller
{
    ...
    {
        $posts = [
            ['id' => 1, 'title' => 'Prvý článok', 'excerpt' => 'Popis prvého článku.'],
            ['id' => 2, 'title' => 'Druhý článok', 'excerpt' => 'Popis druhého článku.'],
            ['id' => 3, 'title' => 'Tretí článok', 'excerpt' => 'Popis tretieho článku.'],
        ];
